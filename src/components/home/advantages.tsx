...
export const Advantages = () => {
  ...
  return (
    <div className="smDesktopPart:py-28 flex min-h-[484px] w-full flex-wrap items-center justify-center gap-8 bg-blackMain text-center desktopEnd:bg-white desktopEnd:py-20 smDesktop:px-4">
